...
public class OnlinecheckApp {

    private static final Logger log = LoggerFactory.getLogger(OnlinecheckApp.class);

    private final Environment env;

    public OnlinecheckApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes onlinecheck.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(OnlinecheckApp.class);
